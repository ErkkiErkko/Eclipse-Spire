...
export const HERO_ART: CharacterArt = {
  src: '/assets/characters/hero-cute.webp',
  alt: '月之剑姬莉雅：银白长发、青色眼睛与蝴蝶结，穿着象牙白和青色短披肩裙装，微笑着握住月刃',
};

export const FOE_ART: Record<string, CharacterArt> = {
  sentinel: { src: '/assets/characters/sentinel.webp', alt: '荆棘守卫：栗色双丸子辫，鼠尾草绿兜帽与叶片盾牌，抱着荆棘短剑的可爱守卫' },
  wraith: { src: '/assets/characters/wraith.webp', alt: '失声歌姬：浅水蓝短卷发，蓝白蓬袖舞台裙，握着铃铛麦克风轻声歌唱' },
  raven: { src: '/assets/characters/raven.webp', alt: '黑羽使徒：深蓝短发、金色眼睛、羽毛贝雷帽与黑白斗篷，俏皮地挥动乌鸦魔杖' },
  duelist: { src: '/assets/characters/duelist.webp', alt: '蔷薇剑姬：珊瑚粉卷曲双马尾，红白蔷薇裙，自信地举起细剑' },
  oracle: { src: '/assets/characters/oracle.webp', alt: '盲眼先知：薄荷绿长直发，星星眼罩和宽袖长袍，双手托起星形水晶' },
  reaper: { src: '/assets/characters/reaper.webp', alt: '收魂女爵：淡紫侧马尾、小礼帽与紫黑娃娃裙，羞涩地抱着弯月镰刀' },
